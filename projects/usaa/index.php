...
<head>
  ...
  <title>USAA Job Finder - Futures Inc.</title>
          ...
          <div class="col-sm-12 columns">
            ...
            <div class="breadcrumbs-wrapper">
              <ol class="breadcrumb">
                ...
                <li class="active">USAA Job Finder</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row">
              ...
              <div class="carousel" data-carousel-autoplay="false" data-carousel-nav="true" data-carousel-pagination="true" data-carousel-single="true" data-carousel-speed="1000" data-carousel-transition="fadeUp">
                ...
                <div>
                  <div class="overlay-wrapper">
                    <img src="../../img/content/projects/usaa-1.jpg" alt="USAA Job Finder"/>
                  </div>                         
                </div><!-- /Carousel Item -->
          ...
          <div class="col-md-4 col-sm-6"> 
            <h4 class="fancy-title"><span>USAA Job Finder</span></h4> 
