...
<head>
	...
	<title>US IT Pipeline - Futures Inc.</title>
          ...
          <div class="col-sm-12 columns">
            ...
            <div class="breadcrumbs-wrapper">
                ...
                <li><a href="<?=BASEURL;?>projects/">Projects</a></li>
								<li class="active">US IT Pipeline</li>
							</ol>
            </div>
					</div>
				</div>
      ...
      <div class="container">
        ...
        <div class="row">
              ...
              <div class="carousel" data-carousel-autoplay="false" data-carousel-nav="true" data-carousel-pagination="true" data-carousel-single="true" data-carousel-speed="1000" data-carousel-transition="fadeUp">
                ...
                <div>
                  <div class="overlay-wrapper">
                    <img src="../../img/content/projects/us-it-pipeline-1.jpg" alt="US IT Pipeline"/>
                  </div>                         
                </div><!-- /Carousel Item -->
          ...
          <div class="col-md-4 col-sm-6"> 
            <h4 class="fancy-title"><span>US IT Pipeline</span></h4> 
            ...
            <ul class="divider-list list-unstyled">
              <li><a href="https://usitpipeline.com" target="_blank">Visit Site</a></li>
            </ul>
            <div class="white-space space-big"></div> 
          </div>
