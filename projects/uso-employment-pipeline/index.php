...
<head>
	...
	<title>USO Employment Pipeline - Futures Inc.</title>
          ...
          <div class="col-sm-12 columns">
            ...
            <div class="breadcrumbs-wrapper">
                ...
                <li><a href="<?=BASEURL;?>projects/">Projects</a></li>
								<li class="active">USO Employment Pipeline</li>
							</ol>
            </div>
					</div>
				</div>
      ...
      <div class="container">
        ...
        <div class="row">
              ...
              <div class="carousel" data-carousel-autoplay="false" data-carousel-nav="true" data-carousel-pagination="true" data-carousel-single="true" data-carousel-speed="1000" data-carousel-transition="fadeUp">
                ...
                <div>
                  <div class="overlay-wrapper">
                    <img src="../../img/content/projects/uso-2.jpg" alt="USO Employment Pipeline"/>
                  </div>                         
                </div><!-- /Carousel Item -->
                ...
                <div>
                  <div class="overlay-wrapper">
                    <img src="../../img/content/projects/uso-1.jpg" alt="USO Employment Pipeline Mobile App"/>
                  </div>                         
                </div><!-- /Carousel Item -->
          ...
          <div class="col-md-4 col-sm-6"> 
            <h4 class="fancy-title"><span>USO Employment Pipeline</span></h4> 
            ...
            <ul class="divider-list list-unstyled">
              <li><a href="https://usoemploymentpipeline.com/" target="_blank">Visit Site</a></li>
              <li><a href="https://itunes.apple.com/us/app/uso-employment-pipeline/id892800391?mt=8" target="_blank">Download iOS</a></li>
              <li><a href="https://play.google.com/store/apps/details?id=com.futeresinc.uso&hl=en" target="_blank">Download Android</a></li>
            </ul>
            <div class="white-space space-big"></div> 
          </div>
