      ...
      <!-- START REVOLUTION SLIDER 3.1 rev5 -->
      <div class="tp-banner-container">
        <div class="tp-banner" >
        	<ul>
        		<!-- SLIDE  -->
        		<li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="1000" data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off"  data-title="We Are Futures">
        			<!-- MAIN IMAGE -->
        			<img src="<?=BASEURL?>img/content/bg-slider-index.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
        			...
        			<div class="tp-caption large_bold_white customin customout tp-resizeme rs-parallaxlevel-3"
        				...
        				style="font-size:90px;line-height:110px;">WE ARE FUTURES
        			</div>
        			...
        			<div class="tp-caption mediumlarge_light_white script-font customin customout tp-resizeme rs-parallaxlevel-4"
        				...
        				data-captionhidden="on"
        				style="z-index: 4; font-size:52px;">Connecting talent with opportunity.
        			</div>
        			...
        			<div class="tp-caption sfb rs-parallaxlevel-5"
        				...
        				style="z-index: 6">
                <a href="#services" class="btn btn-primary btn-lg">What We Do! <i class="fa fa-angle-double-down iconright"></i></a>
        			</div>
