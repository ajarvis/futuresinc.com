...
if (gfx('#google-map-footer').length>0) {
	var e=new google.maps.LatLng(37.331789, -122.029620),
		...
		var g='<div class="map-marker"><h4 class="color-dark xbold">Futures Inc.</h4><p>United States of America</p><p>New York. 123 Fifth Avenue</p></div>',a=new google.maps.InfoWindow({content:g})
